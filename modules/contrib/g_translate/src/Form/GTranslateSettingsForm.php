...
/**
 * @file
 * Contains \Drupal\g_translate\Form\GTranslateSettingsForm.
 */

namespace Drupal\g_translate\Form;
...
class GTranslateSettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $config = $this->config('g_translate.settings');
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->config('g_translate.settings')
    ...
    foreach($this->languages as $lang => $language)
        $this->config('g_translate.settings')->set('gtranslate_'.$lang, $form_value['gtranslate_'.$lang])->save();
